...
Configure the I²S controller to be in output mode.
...
| -------------- | --------------------- | --------------- |
| file           | I²S controller handle | Input           |
...
Configure the I²S controller to capture mode.
...
- [i2s\_align\_mode\_t](#i2salignmodet): I²S align mode.
